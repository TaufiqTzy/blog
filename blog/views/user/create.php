    ...
    <div class="col-md-6">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" name="nama_user" value="<?php if (isset($simpan)) {
                    echo $nama_user;
        ...
        <div class="mb-3">
            ...
            <option value="2" <?php if (isset($simpan)) {
                    $level == "2" ? $selected2 = "selected":$selected2 = "";
                    echo $selected2;
                } ?>>Operator</option>
        </select>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input type="email" name="email" value="<?php if (isset($simpan)) {
                    echo $email;
                } ?>" class="form-control" required>
                <div class="invalid-feedback">
                    Silahkan Isi Email
